...
def basico(pdf):
    ...
    try:
        ...
        pdf.drawString(170, 20, texto_pie)
        pdf.setFont('Helvetica-Bold', size=10)

        pdf.drawString(560, 15,str(pdf.getPageNumber()))

        pdf.line(50, 30, 540, 30)
        return pdf
    ...
    try:
        ...
        for registro in listClientes:
            ...
            if y<= 50:
                ...
                pdf.setFont('Helvetica-Bold', size=10)
                pdf.drawString(560, 15, str(pdf.getPageNumber()))
                pdf.line(50, 800, 540, 800)
                for i in range(0, 4):
                    pdf.setFont('Helvetica-Bold', size=10)
                    pdf.drawString(x, 780, cabecera[i])
                    x += 130
                pdf.line(50, 770, 540, 770)
                pdf.line(50, 30, 540, 30)
                y=750
                x=75
            for i in range(0, 4):
